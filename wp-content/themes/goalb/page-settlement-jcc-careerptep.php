            ...
            <div class="payment-wrapper">
                ...
                <div id="plan-standard" class="payment-card">
                    ...
                    <dic class="payment-card__price-wrap">
                        <h3 class="payment-card__price">550,000円<span>（税込み）</span></h3>
                        <hr class="payment-card__price-divider" />
                    </dic>

                    <button class="payment-card__button">
                        <a href="javascript:void(0);" onclick="f_submit(custCode,opportunityId,'BTH0001','スタンダードプラン',550000)">決済画面に進む</a>
                    </button>
                </div>
                ...
                <div id="plan-Rebooststep" class="payment-card is-active">
                    ...
                    <dic class="payment-card__price-wrap">
                        <h3 class="payment-card__price">520,200円<span>（税込み）</span></h3>
                        <hr class="payment-card__price-divider" />
                    </dic>

                    <button class="payment-card__button">
                        <a href="javascript:void(0);" onclick="f_submit(custCode,opportunityId,'BTH0001','プレミアムブレイクスループラン',520200)">決済画面に進む</a>
                    </button>
                </div>
            </div>
        </div>
