...
<main class="l-content">
    ...
    <div class="m-pageTitle">
        <h1><span class="japanese">GOAL-Bについて</span><span class="english">ABOUT</span></h1>
    </div>
        ...
        <div class="m-textimage">
            ...
            <div class="m-textimage__items" data-appear-animation="fadeIn">
                <div class="m-textimage__image"><img loading="lazy"
                        src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/about/message-picture2.jpeg"
                        alt="" /></div>
                <div class="m-textimage__texts">
                    ...
                    <p class="m-textimage__text02">正解のない世界で自分はどう生きるのか。
                        ...
                        あなたの最高の一日を生きるための「GOAL-B」はなんでしょうか。<br>
                        GOAL-Bは、あなたのGOALを実現するためのきっかけで在り続けます。
                    </p>
                </div>
            </div>
        </div>
