        ...
        <div class="m-textimage">
            ...
            <div class="m-textimage__items" data-appear-animation="fadeIn">
                ...
                <div class="m-textimage__texts">
                    ...
                    <p class="m-textimage__text02">
                        正解のない世界で自分はどう生きるのか。<br>
                        どんな人生を生きていれば「充実感」を感じるのか。<br>
                        私は充実感を与えるものは、自分の人生の目的に沿った生き方をすることだと思っています。<br>
                        今の自分の状況はすべて、過去無数にある選択肢の中から自分で選んできた結果です。<br>
                        人生において充実感を感じて生きるには、この目の前の選択肢を、自分に響いている方向へ取っていく必要があります。<br>
                        それを実際に取っていくには、今の自分の実力では難しいこともあるかもしれません。恐れがあるかもしれません。<br>
                        それでも自分に響いた生き方をするために、自らを変えていく。<br>
                        自分を変える勇気があれば、どこまででも行ける。<br>
                        私たちはそんな<br>
                        自らの可能性を開放し、夢中な人生を生きる人でいっぱいになることをビジョンに進んでいきます。
                    </p>
                </div>
            </div>
        </div>
