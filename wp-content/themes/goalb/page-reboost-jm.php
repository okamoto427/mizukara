        ...
        <div class="sectionCoach__conte">
            ...
            <div class="sectionCoach__txt">
                ...
                <p class="p">
                    ...
                    執行役員<br>2022年：(株)ミズカラ 入社<br>2023年：一般社団法人キャリアコーチング協会代表理事 </p>
...
<section class="section">
    <div class="wrap">
        <h2 class="headingSection">あなたの進化をサポートする<br>ミズカラメンバー</h2>
        <div class="boxMedia">

            <div class="boxMedia__conte">
                <p class="p">当日は、講師の島田だけでなく、<br class="u-br_pc">ミズカラメンバー複数人で<span class="u-bold">あなたの人生を前進させます。</span>
                </p>
            ...
            <div class="boxStickArticle__article">
                ...
                <div class="tableAccordion js-accordion u-stackLg">
                    ...
                    <div class="tableAccordion__openContent js-openContent">
                        ...
                        <div class="u-stackLg">
                            <h3 class="boxStickArticle__heading">受講した理由</h3>
                            <p class="p">Reboost講師の村岡さん（現在ミズカラ 代表取締役CEO）の個別コーチングを受けていました。</p>
