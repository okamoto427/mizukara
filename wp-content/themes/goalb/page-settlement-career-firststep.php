...
<link href="https://fonts.googleapis.com/css2?family=Noto+Sans+JP:wght@300;400;500;700;900&amp;family=Prompt:wght@300;400;500;600;700;800&amp;display=swap" rel="stylesheet">
...
<style id='global-styles-inline-css' type='text/css'>
    ...
    <main class="l-payment">
        ...
        <div class="payment-main">
            <div class="payment-card is-active">
                <div class="payment-card__plan-wrap">
                    <h2 class="payment-card__title">ファーストステップ<br class="payment-only-sp">プラン</h2>
                ...
                <dic class="payment-card__price-wrap">
                    <h3 class="payment-card__price">360,800円<span>（税込み）</span></h3>
                    <hr class="payment-card__price-divider" />
                    <p class="payment-card__price-detail">プラン料金 298,000円 + <br class="payment-only-sp">入会金 33,000円</p>
                </dic>

                <button class="payment-card__button">
                    <a href="javascript:void(0);" onclick="f_submit(custCode,opportunityId,'careerspeed-firststep','ファーストステッププラン',360800)">決済画面に進む</a>
                </button>
            </div>
        </div>
    </main>