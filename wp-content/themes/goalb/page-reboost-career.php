    ...
    <div class="sectionCoach__inner">
        ...
        <div class="sectionCoach__conte">
            ...
            <div class="sectionCoach__txt">
                ...
                <p class="p">2023年12月、株式会社ミズカラ代表取締役CEOに就任。</p>
...
<section class="section">
    <div class="wrap">
        <h2 class="headingSection">あなたの進化をサポートする<br>ミズカラサポートコーチ</h2>
        <div class="boxMedia">
            ...
            <div class="boxMedia__conte">
                <p class="p">当日は、講師の村岡だけでなく、<br class="u-br_pc">ミズカラコーチ複数人で<span
                ...
                <div class="tableAccordion js-accordion u-stackLg">
                    ...
                    <div class="tableAccordion__openContent js-openContent">
                        <div class="u-stackLg">
                            ...
                            <p>もう1つは<span class="u-bold">ミズカラさんのYouTubeを見て<br
                ...
                <div class="tableAccordion js-accordion u-stackLg">
                    ...
                    <div class="tableAccordion__openContent js-openContent">
                        ...
                        <div class="u-stackLg">
                            ...
                            <p class="p">それでミズカラさんのことを知っていくようになって<br
                ...
                <div class="tableAccordion js-accordion u-stackLg">
                    ...
                    <div class="tableAccordion__openContent js-openContent">
                        ...
                        <div class="u-stackLg">
                            ...
                            <p class="p">自分自身もコーチングに近いライフコーチングを、<br class="u-br_pc">ミズカラが提供しているものとはちょっと違うと思うのですが、<br
...
<section id="registration" class="section is-gray">
    ...
    <div class="wrap--narrow">
        <div class="boxCta">
            ...
            <?php endif; ?>
            <a href="https://cbgw.kuzen.io/line_auth/liff_fwd_to_login?sl=483bd37395&lp=lp_career&lp2=lp_career"
                target="_blank" rel="noopener" data-btnIcon="&#xf105;" class="boxCta__btn">席が埋まる前に申し込む</a>
...
<section class="section">
    <div class="wrap">
        ...
        <p class="p textMd">
            「身体と心が変われば人生が変わる」この核心をもとに「フィットネス」と「コーチング」の事業を展開する株式会社ミズカラを2019年に創業。<br>「Body（身体）とBe（心）を改革しGOALを達成する」これがミズカラの由来です。
        </p>
