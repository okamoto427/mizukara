...
<head>
    ...
    <link rel="stylesheet"
        href="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets-career_gsn_co/css/styles04.css" />
    ...
    <main>
        <header class="header js-header">
            ...
            <div class="header__drawer drawer-menu js-drawer-menu">
                ...
                <div class="drawer-menu__button"><a href="#" class="button">無料体験コーチングを申し込む</a></div>
            </div>
        </header>
        <section class="mv js-mv">
            <div class="mv__wrap">
                ...
                <div class="mv__main wow animated fadeInUp" data-wow-delay=".3s">
                    ...
                    <div class="mv__button"><a href="#" class="button">無料体験コーチングを申し込む</a></div>
                </div>
            </div>
        </section>
        <!-- 体験談 -->
        <section class="voice" id="client">
            <h2 class="voice__title section-title wow animated fadeInUp" data-wow-delay=".4s">
                <span class="section-title--en">CLIENT</span>
                活躍中の受講生たち
            </h2>
        ...
        <div class="cv-area wow animated fadeInUp" data-wow-delay=".4s">
            ...
            <div class="cv-area__button"><a href="#" class="button">無料体験コーチングを申し込む</a></div>
        </div>
        <!-- よくある質問 -->
        ...
        <div class="flooting-button">
            <a href="#" class="button">無料体験コーチングを申し込む</a>
        </div>
    </main>
    <footer class="footer">
