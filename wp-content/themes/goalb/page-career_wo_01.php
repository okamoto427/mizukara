...
<head>
    ...
    <title>もう同じことで悩みたくない！一人で抱え込むのは今日で終わり！</title>
    <!--  アイコン関連  -->
...
<!-- End Google Tag Manager (noscript) -->
    <main>
        <div class="wrapper">
            ...
            <div class="mv">
                <h1 class="mv__text ">
                    <img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets-career_wo/images/mv-text.png"
                        alt="もう同じことで悩みたくない！1人で抱え込むのは今日で終わり！" width="650" height="291" />
                </h1>
                <div class="mv__img">
                    <picture>
                        <source
