        ...
        <div class="payment-main">
            <div class="payment-card is-active">
                <div class="payment-card__plan-wrap">
                    <h2 class="payment-card__title">メンバー価格（Reboost除く）<br class="payment-only-sp">プラン</h2>
                    <div class="payment-card__title-line"></div>
                </div>

                <dic class="payment-card__price-wrap">
                    <h3 class="payment-card__price">450,000円<span>（税込み）</span></h3>
                    <hr class="payment-card__price-divider" />
                </dic>

                <button class="payment-card__button">
                    <a href="javascript:void(0);" onclick="f_submit(custCode,opportunityId,'BTH0001','ファーストステッププラン',450000)">決済画面に進む</a>
                </button>
            </div>
        </div>
    </main>