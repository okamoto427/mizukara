        ...
        function toggleVisibility(tabId) {
            ...
            switch (tabId) {
                case 'standard':
                    ...
                    document.getElementById('tab-Rebooststep').classList.remove('is-active');
                    document.getElementById('plan-standard').style.display = 'block';
                    document.getElementById('plan-Rebooststep').style.display = 'none';
                    break;
                case 'Rebooststep':
                    document.getElementById('tab-standard').classList.remove('is-active');
                    document.getElementById('tab-Rebooststep').classList.add('is-active');
                    document.getElementById('plan-standard').style.display = 'none';
                    document.getElementById('plan-Rebooststep').style.display = 'block';
                    break;
            }
        }
    </script>
        ...
        <div class="payment-main">
            <div class="payment-wrapper">
                <div class="payment-tab">
                    <button id="tab-standard" class="payment-tab__item" onclick="toggleVisibility('standard')">通常価格（Reboost含む）</button>
                    <button id="tab-Rebooststep" class="payment-tab__item is-active" onclick="toggleVisibility('Rebooststep')">Reboost受講済みの方</button>
                </div>
                
                <!-- スタンダードプラン -->
                <div id="plan-standard" class="payment-card">
                    <div class="payment-card__plan-wrap">
                        <h2 class="payment-card__title">通常価格（Reboost含む）</h2>
                        <div class="payment-card__title-line"></div>
                    </div>

                    <dic class="payment-card__price-wrap">
                        <h3 class="payment-card__price">770,000円<span>（税込み）</span></h3>
                        <hr class="payment-card__price-divider" />
                    </dic>

                    <button class="payment-card__button">
                        <a href="javascript:void(0);" onclick="f_submit(custCode,opportunityId,'BTH0001','スタンダードプラン',770000)">決済画面に進む</a>
                    </button>
                </div>

                <!-- プレミアムブレイクスループラン -->
                <div id="plan-Rebooststep" class="payment-card is-active">
                    <div class="payment-card__plan-wrap">
                        <h2 class="payment-card__title">Reboost受講済みの方</h2>
                        <div class="payment-card__title-line"></div>
                    </div>

                    <dic class="payment-card__price-wrap">
                        <h3 class="payment-card__price">740,200円<span>（税込み）</span></h3>
                        <hr class="payment-card__price-divider" />
                    </dic>

                    <button class="payment-card__button">
                        <a href="javascript:void(0);" onclick="f_submit(custCode,opportunityId,'BTH0001','プレミアムブレイクスループラン',740200)">決済画面に進む</a>
                    </button>
                </div>
            </div>
        </div>
