...
<!-- End Google Tag Manager -->
    ...
    <link rel="stylesheet"
        href="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets-career_gsn_co/css/styles05.css" />
...
<!-- End Google Tag Manager (noscript) -->
    <main>
        <header class="header js-header">
            <div class="header__inner">
                <div class="header__wrap">
                    ...
                    <div class="header__button">
                        <a href="https://liff.line.me/1657004383-AmL9D9Yw/landing?follow=%40712eemnx&lp=6DcKqy&liff_id=1657004383-AmL9D9Yw" data-cats=lineFriendsFollowLink target="_blank">無料体験コーチングを申し込む</a>
                    </div>
                </div>
            </div>
            ...
            <div class="header__drawer drawer-menu js-drawer-menu">
                ...
                <div class="drawer-menu__button">
                    <a href="https://liff.line.me/1657004383-AmL9D9Yw/landing?follow=%40712eemnx&lp=6DcKqy&liff_id=1657004383-AmL9D9Yw” data-cats="lineFriendsFollowLink"  target="_blank" class="button">無料体験コーチングを申し込む</a>
                </div>
            </div>
        </header>
            ...
            <div class="mv__wrap">
                ...
                <div class="mv__main wow animated fadeInUp" data-wow-delay=".3s">
                    ...
                    <div class="mv__button"><a
                            href="https://liff.line.me/1657004383-AmL9D9Yw/landing?follow=%40712eemnx&lp=6DcKqy&liff_id=1657004383-AmL9D9Yw"
                            data-cats=lineFriendsFollowLink target="_blank" class="button">無料体験コーチングを申し込む</a></div>
                </div>
            </div>
        </section>
        <!-- 体験談 -->
        <section class="voice" id="client">
            ...
            <div class="voice__wrap">
                <div class="voice__img"><img
                        src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets-career_gsn_co/images/common/voice__img01.webp"
                        alt="サムネ画像１"></div>
                <div class="voice__img"><img
                        src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets-career_gsn_co/images/common/voice__img02.jpg"
                        alt="サムネ画像２"></div>
                <div class="voice__img"><img
                        src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets-career_gsn_co/images/common/voice__img03.webp"
                        alt="サムネ画像３"></div>
                <div class="voice__img"><img
                        src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets-career_gsn_co/images/common/voice__img04.jpg"
                        alt="サムネ画像４"></div>
                <div class="voice__img"><img
                        src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets-career_gsn_co/images/common/voice__img05.jpg"
                        alt="サムネ画像５"></div>
                <div class="voice__img"><img
                        src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets-career_gsn_co/images/common/voice__img06.jpg"
                        alt="サムネ画像６"></div>
            </div>
            <p class="voice__attention">※成果を保証するものではありません。</p>
        </section>
                ...
                <div class="about__item">
                    <div class="about__main">
                        <h2 class="about__title wow animated fadeInUp" data-wow-delay="1s">
                            キャリスピは<br>あなたの強みを引き出す<br class="u-desktop" />キャリア形成のプロによるコーチングです</h2>
                        ...
                        <div class="about__texts">
                            <p>「仕事が上手くいかない」<br>「自分のやりたいことが何か分からない」
                                <br>こういった悩みを抱えている方は自分の「強み」を活かせていない・気づけていない可能性が高いです。
                            </p>
                            <p><span class="text-green">「自分では強みだと認識していないことが、<br
                                        class="u-desktop" />実は周りから見ると凄いこと・真似するのが難しいことだった」</span></p>
                            <p>このような状況に自分の思考だけで気づくのは至難の業です。
            ...
            <div class="reason__wrap">
                ...
                <div class="reason__item wow animated fadeInLeft" data-wow-delay=".7s">
                    ...
                    <div class="reason__img">
                        <picture>
                            <source
                                srcset="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets-career_gsn_co/images/common/reason__img01-02@2x.webp"
                                type="image/webp" width="420" height="249" loading="lazy" />
                            <img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets-career_gsn_co/images/common/reason__img01-02@2x.jpg"
                ...
                <div class="reason__item wow animated fadeInLeft" data-wow-delay=".9s">
                    ...
                    <div class="reason__img">
                        <picture>
                            <source
                                srcset="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets-career_gsn_co/images/common/reason__img03-02@2x.webp"
                                type="image/webp" width="420" height="249" loading="lazy" />
                            <img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets-career_gsn_co/images/common/reason__img03-02@2x.jpg"
                ...
                <div class="flow__item wow animated fadeInUp" data-wow-delay=".6s">
                    <div class="flow__texts">
                        ...
                        <p class="flow__text02">
                            仕事の年収が上がらない<br>仕事にモチベーションが湧かない<br>家族と仕事の両立がうまくいかないなどあなたの現状をお聞かせください。<br>（モヤモヤしているといった内容でも大丈夫です！）
                        </p>

                    </div>
                    <div class="flow__img">
                        <img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets-career_gsn_co/images/common/flow__img-sp02-new.png"
                            alt="公式LINEから無料カウンセリングを申し込む" loading="lazy" />
                    </div>
                </div>
                <!-- ３つ目 -->
                <div class="flow__item wow nimated fadeInUp" data-wow-delay=".7s">
                    <div class="flow__texts">
                        <div class="flow__head">
                            <span class="flow__head-en">STEP</span>
                            03
                    ...
                    <div class="flow__img">
                        <img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets-career_gsn_co/images/common/flow__img-sp03-new.png"
        ...
        <div class="cv-area wow animated fadeInUp" data-wow-delay=".4s">
            <div class="cv-area__head">
                <div class="cv-area__title">
                    <span class="cv-area__head">枠が埋まり次第終了！</span><br>
                    <span class="text-green">通常5,500円の体験コーチング</span>を<br>LINE追加して今すぐ申し込む
                </div>
            </div>
            <div class="cv-area__button"><a
                    href="https://liff.line.me/1657004383-AmL9D9Yw/landing?follow=%40712eemnx&lp=6DcKqy&liff_id=1657004383-AmL9D9Yw"
                    target="_blank" data-cats=lineFriendsFollowLink class="button">無料体験コーチングを申し込む</a>
            </div>
        </div>
        <!-- コーチ紹介 -->
        ...
        <div class="cv-area wow animated fadeInUp" data-wow-delay=".4s">
            ...
            <div class="cv-area__button">
                <a href="https://liff.line.me/1657004383-AmL9D9Yw/landing?follow=%40712eemnx&lp=6DcKqy&liff_id=1657004383-AmL9D9Yw"
                    target=“_blank” data-cats=lineFriendsFollowLink class="button">無料体験コーチングを申し込む</a>
            </div>
        </div>
        <!-- 追従ボタン -->
    ...
    <footer class="footer">
        ...
        <p class="footer__copyright"><span>&copy;</span> 2024 Mizukara,Inc. All rights Reserved</p>
    </footer>
    <script>
    new WOW().init();
    </script>
