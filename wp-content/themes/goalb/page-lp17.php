<?php
/*
 Template Name: Reboost LP_LINE配信用_リブーストLINE
*/
?>
...
<header id="header" class="siteHeader">
  <p class="siteHeader__logo">
    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/reboost/logo.svg" alt="GOAL-B" width="118" height="25">
  </p>
  <div class="keyVisual">
...
<section class="sectionCoach">
  ...
  <div class="sectionCoach__inner">
    ...
    <div class="sectionCoach__conte">
      <p class="sectionCoach__pos">株式会社GOAL-B <br class="u-br_sp">CSO（最高戦略責任者）兼 プロコーチ</p>
      ...
      <div class="sectionCoach__txt">
        <p class="p">株式会社GOAL-BでCSOとして働きながら、代表を務める合同会社LIMITにて、パーソナルジムを10店舗/民泊1棟を経営。</p>
        ...
        <p>現在は自身の会社を経営しながら、GOAL-BのCSOを務める。自身の能力を抑えていた信念を取り払うことで、理想的な人生を実現している。</p>
      </div>
    </div>
  </div>
</section>
...
<section id="registration" class="section is-gray">
  ...
  <div class="wrap--narrow">
    <div class="boxCta">
      ...
      <?php endif; ?>
      <a href="https://liff.line.me/1657688022-nXNE1oDa/landing?follow=%40860gpcyg&lp=5IbzFK&liff_id=1657688022-nXNE1oDa" target="_blank" rel="noopener" data-btnIcon="&#xf105;" class="boxCta__btn">席が埋まる前に申し込む</a>
  ...
  <div class="wrap">
    ...
    <div class="boxAbout">
      <div class="boxAbout__item is-01">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_about_01.jpg" srcset="<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_about_01.jpg 1x,<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_about_01@2x.jpg 2x" alt="株式会社GOAL-Bについて" width="435" height="232" loading="lazy" decoding="async">
      </div>
      <div class="boxAbout__item is-02">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_about_02.jpg" srcset="<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_about_02.jpg 1x,<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_about_02@2x.jpg 2x" alt="株式会社GOAL-Bについて" width="146" height="232" loading="lazy" decoding="async">
      </div>
      <div class="boxAbout__item is-03">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_about_03.jpg" srcset="<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_about_03.jpg 1x,<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_about_03@2x.jpg 2x" alt="株式会社GOAL-Bについて" width="157" height="233" loading="lazy" decoding="async">
        <p class="boxAbout__note">著書１万部突破<br><span>※2022年5月時点</span></p>
      </div>
      <div class="boxAbout__item is-04">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_about_04.jpg" srcset="<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_about_04.jpg 1x,<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_about_04@2x.jpg 2x" alt="株式会社GOAL-Bについて" width="355" height="232" loading="lazy" decoding="async">
    ...
    <p class="p textMd">これらの体験から、「身体と心が変われば人生が変わる」この核心をもとに「フィットネス」と「コーチング」の事業を展開する株式会社GOAL-Bを2019年に創業。<br>「Body（身体）とBe（心）を改革しGOALを達成する」これがGOAL-Bの由来です。</p>
