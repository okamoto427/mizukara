...
<header id="header" class="siteHeader">
  <p class="siteHeader__logo">
    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/shared/logo.svg" alt="GOAL-B" width="118" height="25">
  </p>
  <div class="keyVisual">
  ...
  <div class="wrap">
    ...
    <div class="cardPoint">
      <div class="cardPoint__conte">
        ...
        <p class="cardPoint__txt">人の目や意見を気にして、自分に制限をかけていませんか？<br class="u-br_pc">他人の意見に左右されず、人生の主導権を取り戻し、あなたと、大切な人の人生をより良い方に導けるようになるでしょう。</p>
      </div>
      <div class="cardPoint__img">
...
<section class="sectionCoach">
  ...
  <div class="sectionCoach__inner">
    ...
    <p class="sectionCoach__pos">株式会社GOAL-B <br class="u-br_sp">CEO代表取締役 兼 エグゼクティブコーチ</p>
      ...
      <p class="p">株式会社GOAL-BでCEO 代表取締役として仕事を行いながら、代表を務める合同会社LIMITにて、パーソナルジムを10店舗/民泊1棟を経営。</p>
        ...
        <p>自身の能力を抑えていた信念を取り払うことで、理想的な人生を実現している。</p>
      </div>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="wrap">
    <h2 class="headingSection">あなたの進化をサポートする<br>GOAL-Bメンバー陣</h2>
    <div class="boxMedia">
      ...
      <div class="boxMedia__conte">
        <p class="p">当日は、講師の村岡だけでなく、<br class="u-br_pc">GOAL-Bメンバー複数人で<span class="u-bold">あなたの人生を前進させます。</span><br>※メンバー全員での参加ではありません。</p>
  ...
  <div class="wrap">
    ...
    <div class="boxStickArticle">
      <div class="boxStickArticle__card">
          ...
          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_proprietor_01.jpg" srcset="<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_proprietor_01.jpg 1x,<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_proprietor_01@2x.jpg 2x" alt="徳武輝彦さん" width="316" height="307" loading="lazy" decoding="async">
        </div>
      <div class="boxStickArticle__article">
        <div class="u-stackLg">
          ...
          <p class="p">コンサル事業をReboost受ける前からも始めていましたが、売上はReboostを受けてから<br class="u-br_pc"><span class="u-bold">今月（2023年11月）単月で8桁（売上1000万円以上）いきました。</span></p>
          <p>コンサル事業としては初の売上なのでこの成果はReboostの影響が大きかったです。</p>
        </div>
        <div class="tableAccordion js-accordion u-stackLg">
        <p class="tableAccordion__toggle js-listToggle"><span class="tableAccordion__icon"><span></span><span></span></span></p>
          <div class="tableAccordion__openContent js-openContent">
            <div class="u-stackLg">
              ...
              <p>もう1つは<span class="u-bold">GOAL-BさんのYouTubeを見て<br class="u-br_pc">良いチーム、良い会社さんだなと思って参加しようと思いました。</span></p>
            </div>
            <div class="u-stackLg">
              <h3 class="boxStickArticle__heading">受講後の変化</h3>
              <p class="p u-bold">感情にアクセスする、自分が本当に欲しいものを明確に出せるようになりました。</p>
              <p class="p u-bold">奥の方にあったけど、事業ですごい経費がかかると思うと<br class="u-br_pc">現実的じゃないなみたいなブレーキを踏んでいました。</p>
              <p class="p">Reboostで感情にアクセスすることを学ばさせていただいて<br class="u-br_pc">奥にある1番の自分の大事な思いを出した方がいい。そういう価値基準が1個増えました。</p>
              <p></p>
            </div>
            <div class="u-stackLg">
              <h3 class="boxStickArticle__heading">受講した一番の価値</h3>
              <p class="p">自分の奥に眠ってる感情にアクセスできたところ。<br><span class="u-bold">自分の本当にやりたいことにフルアクセルを踏めるようになりました。</span><br>決断の壁を1つ乗り越えられたのが大きかったです。</p>
              <p class="p u-bold">今回も単月で1000万上がりました。</p>
              <p class="p u-bold">結構な投資をしなければいけなかったので、<br class="u-br_pc">深く感情にタッチできるようになって、やっぱこの想いを出した方がいいなと思い<br class="u-br_pc">怖さもありつつ大きな決断ができました。</p>
            ...
            <div class="u-stackLg">
              ...
              <p class="p">私は社員数も数名なので大きな会社ではないです。<br><span class="u-bold">数名の会社さんとか1人会社、1人社長さんとか結構いらっしゃると思います。</span><br>そうなると<span class="u-bold">自分の意思決定がすごく会社の売上の方向性を左右します。<br>自分の影響力が数名の会社ほどすごく大きいと思います。</span></p>
              <p class="p">そんな人でやっぱり<span class="u-bold">本当はこれしたいみたいに<br class="u-br_pc">奥そこで思っているけどいろんな不安とか恐怖とか<br class="u-br_pc">資金面とかでちょっと蓋をしている状態が続いてるような方。</span></p>
            ...
            <div class="u-stackLg">
              ...
              <p class="p">会社の影響に関わるようなことでモヤモヤしてるような方がいたら<br class="u-br_pc">受けるとその決断をどうしたらいいかが明確になります。</p>
              <p>迷ったり、モヤモヤしているものがある経営者さんだったら<br class="u-br_pc">1回受けてモヤモヤが何なのか、本当にしたいことは何かをクリアにして欲しいなと思います。</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="boxStickArticle">
      <div class="boxStickArticle__card">
          ...
          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_proprietor_03.jpg?22" srcset="<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_proprietor_03.jpg?22 1x,<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_proprietor_03@2x.jpg?22 2x" alt="池田園子さん" width="316" height="307" loading="lazy" decoding="async">
        </div>
      <div class="boxStickArticle__article">
          <p class="boxStickArticle__ttl">自分の感情を大事に行動できるようになった</p>
          <h3 class="boxStickArticle__heading">ビフォーアフター</h3>
          <p class="p"><span class="u-bold">Must発想だったからこそ、モチベーションが湧きづらくて<br class="u-br_pc">目の前の仕事をやるともうそれをやる力が出ないみたいな状態だったんですけど</span></p>
          <p class="p u-bold">新規事業を作りたいという自分の本来奥底にある感情っていうところにアプローチして<br class="u-br_pc">Want（~~したい）発想がちょっと湧き上がってきてる変化があります。</p>
          ...
          <div class="tableAccordion js-accordion u-stackLg">
            ...
            <div class="u-stackLg">
              ...
              <p class="p">それでGOAL-Bさんのことを知っていくようになって<br class="u-br_pc">LINEに登録したらReboostのオンライン体験会の案内が届きました。</p>
              <p class="p">Reboost講師の村岡さんがお話しされる内容で興味を持って<br class="u-br_pc">村岡さんが面白いのなんのって、この人やばいって思ったんです。</p>
              <p class="p">GOAL-Bさんに興味があったし行ってみたいな、と。</p>
              <p class="p">むしろ内容があまり明かされてなかったからこそ、<br class="u-br_pc">これは行かないと分からんでしょうと思い切って申し込みました。</p>
              <p class="p">あとは<span class="u-bold">2020年度はコロナの影響で会社の売上が何千万か下がってしまったんですけど<br class="u-br_pc">その後は持ち直していって最高収益を達成していて<br class="u-br_pc">既存のお客様だったりこれまで慣れてきた仕事に支えられていて<br class="u-br_pc">安定・現状維持があって甘えてるなというのがありました。</span></p>
              <p class="p u-bold">自分の中で変わりたい、でも何すればいいんだろうっていう<br class="u-br_pc">代表として不甲斐ない状態でもあったので<br class="u-br_pc">そこは変わりたいと感じて申し込みました。</p>
              <p class="u-bold">セルフコーチングについてもできるようになったらすごくいいし<br class="u-br_pc">自分の仕事やメンバーと向き合うときにも活きてくるだろうなという理由で申し込みました。</p>
            </div>
            ...
            <div class="u-stackLg">
              ...
              <p class="p">お客さん、自分が関わる人たちに満足してもらえるように<br class="u-br_pc">これをやっていくような目線でしか物事をやっていませんでした。</p>
              <p class="p">自分と対話してゆっくり考えるみたいなことがほぼなかったので<br class="u-br_pc">それを毎日ノートに書きながら時間を意識的に取るようになっています。</p>
              <p class="p">それに付随した変化なのですが、<br class="u-br_pc"><span>心の奥にある何々したいっていう純粋な感情というものに素直になれ始めました。</span></p>
              <p class="u-bold">何々したいって思った行動をすぐするようになったり<br class="u-br_pc">感情へのアクセス、自分の感情を大事にした行動を取るみたいなことが大きな価値です。</p>
            </div>
    
            <div class="u-stackLg">
              <h3 class="boxStickArticle__heading">オススメしたい会社・組織は？</h3>
              <p class="p u-bold">企業の規模を問わず、みんなに受けて欲しいです。</p>
              <p class="p">なぜならReboostが提案している<br class="u-br_pc">本来の自分を取り戻して<br class="u-br_pc">ありのままの自分を愛して生きるっていう思想は<br class="u-br_pc">誰が持ってもいいものだし<br class="u-br_pc">それを持っていたらみんなが幸せになる。</p>
              <p>争いごと、良くないことも起きないんじゃないかって思うぐらい<br class="u-br_pc"><span class="u-bold">素晴らしい考え方、あり方なので受けて欲しいし<br class="u-br_pc">もう日本人全員受けた方がいいよってぐらいの内容です。</span></p>
            </div>
    
            <div class="u-stackLg">
              <h3 class="boxStickArticle__heading">受けようか迷ってる方へ</h3>
              <p class="p">迷っているのは何かしら自分の心に刺さるところがあり、<br class="u-br_pc">つっかえたモノが取れない状態だと想像しています。</p>
              <p class="p">リブーストを知っている時点で運命的なものもあるでしょうし、<br class="u-br_pc">人生の2日間ですから思い切って受けて欲しいなと感じています。</p>
              <p class="p">私個人としては普段経験しない<br class="u-br_pc">日常で出会わない人たち、普段友達にはいない人<br class="u-br_pc">いろんな方と向き合って本音で全力で取り組めました。</p>
              <p class="p">日常にいたら手に入らない経験、<br class="u-br_pc">見えてこない感情、考え方が確実に2日間の中で溢れているので<br class="u-br_pc">価格をはるかに超える価値があったと感じています。</p>
    ...
    <div class="boxStickArticle">
      <div class="boxStickArticle__card">
          ...
          <p class="boxStickArticle__tag">仕事内容</p>
          <p class="boxStickArticle__txt">サロンを4店舗経営。<br>女性向けの1対複数向けのライフコーチングをオンラインメインで提供。<br>ヘッドスパの講師。サロン特化型のコンサルを行う。</p>
          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_proprietor_02.jpg?22" srcset="<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_proprietor_02.jpg?22 1x,<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_proprietor_02@2x.jpg?22 2x" alt="坂本裕美さん" width="316" height="307" loading="lazy" decoding="async">
        </div>
      <div class="boxStickArticle__article">
          ...
          <p class="p">そこで宣言することで、<span class="u-bold">自分を信じてやりきろうみたいな力がすごく強くなって<br class="u-br_pc">自分に大丈夫だよって日々の中で言ってあげられるようになりました。</span></p>
          <div class="tableAccordion js-accordion u-stackLg">
            <p class="tableAccordion__toggle js-listToggle"><span class="tableAccordion__icon"><span></span><span></span></span></p>
            <div class="tableAccordion__openContent js-openContent">
          <p class="p">それが1番の大きな変化です。</p>
          <p class="p u-bold">2つ目、自分の1番やりたかった女性向けの1対複数人でのコーチングで大きな売上を立てられたこと。</p>
          <p class="p">サロン経営メインでやっていたんですけど<br class="u-br_pc">構想があっても<span class="u-bold">0から立ち上げる新規事業だったので<br class="u-br_pc">失敗したらどうしようとか不安が自分の奥底にありました。</span></p>
          ...
          <p class="p">何よりも自分の中から湧いてきた<br class="u-br_pc">1番やりたいと思っていた新しい事業だったので<br class="u-br_pc">そこのゴール設計ができたり、そこに向かって進めているのがすごく大きな変化です。</p>
          <p class="p u-bold">3つ目、家族や人間関係との関わりがより深くなったこと。</p>
          <p class="u-stackLg">日々の中で当たり前のことにすごく感謝をしたり<br class="u-br_pc"><span class="u-bold">表面的なものではなくて内側から湧いてきて<br class="u-br_pc">本当に1つ1つの幸せを噛みしめるような生き方になりました。</span></p>

            <div class="u-stackLg">
              <h3 class="boxStickArticle__heading">受講した理由</h3>
              <p class="p">Reboost講師の村岡さんの個別コーチングを受けていました。</p>
              <p class="p">村岡さんと元々知り合いで「1つやりたかった俺の夢が叶うんだよね」っていう話を聞いていて<br class="u-br_pc">それがReboostの事業だったので是非それを私もキャッチしたいと思いました。</p>
              <p class="p">あと個別コーチングをしていただいて結果が出たり変化がすごくあったので<br class="u-br_pc">コーチングが終わる時期だったこともあり、<br class="u-br_pc">ここに来れば確信度が高まるっていうのが互いに分かっていた。</p>
            ...
            <div class="u-stackLg">
              ...
              <p class="p">思考優位で経営者なので頭で考えてロジカルに繋げることが得意だったり<br class="u-br_pc">俯瞰して世の中を見たりできるところが私は得意分野です。</p>
              <p class="p">けど、そうすると脳がいつも働いていて<br class="u-br_pc">内側から湧き出てくる感情は後回しにしてしまうことが多かったです。</p>
              <p>でもすごく大切な部分というのに気づいて<br class="u-br_pc"><span class="u-bold">「感じる」にフォーカスする時間をあえて取ったり<br class="u-br_pc">今、自分はどう感じているんだろうという目線をすごく持てるようになりました。</span></p>
            </div>
    
            <div class="u-stackLg">
              <h3 class="boxStickArticle__heading">受講した一番の価値</h3>
              <p class="p u-bold">感じることを感じさせてくれる場所って<br class="u-br_pc">あんまりないと思っています。</p>
              <p class="p">学ぶ、やり方を教わることが多いと思うんですけど、初めに村岡さんに言われたのが<br class="u-br_pc">「紙とペンは持ってきてもらうけどほぼ使わないよ。そういうのじゃないから。」<br class="u-br_pc">みたいな説明を受けて、どういうこと？という感覚でした。</p>
              <p class="p">でも本当にその通りでした。</p>
              <p class="p">内容は知らない方がいいので多くは語れないんですけど<br class="u-br_pc">自分が今までやってきたことと向き合いの質が全然違う、方向性が違う。</p>
              <p class="p">学ぶとか、外側からの知識ってほぼいらないんだなって、すごい衝撃があって。</p>
              <p class="p">自分自身もコーチングに近いライフコーチングを、<br class="u-br_pc">GOAL-Bが提供しているものとはちょっと違うと思うのですが、<br class="u-br_pc">その組み立てをしていく中でのヒントもすごくありました。</p>
              <p class="p">私が逆にライフコーチングをリリースしきれなかったのは<br class="u-br_pc">頭でっかちなものを提供しても意味がないというのがありました。</p>
              ...
              <p class="u-bold">ご紹介させて頂いたりもしているのですけど<br class="u-br_pc">本当に主人にも受けて欲しいし<br class="u-br_pc">子供も対象の年齢になったら受けてほしいです、そう思うぐらいの価値です。</p>
            </div>
            ...
            <div class="u-stackLg">
              ...
              <p class="p">自分と繋がる時間を経営者の皆さん大事にして頂いて、<br class="u-br_pc">組織を持っている方、組織の幹部にいる方、役員の方は自分がまず体感して欲しいです。</p>
              <p class="p">そこから派生していって従業員に受けさせたいとなっていくと思います。</p>
              <p class="u-bold">会社全体が受けていただいたりすると<br class="u-br_pc">すごく組織力が変わっていくんじゃないかなって、目に見えて分かります。</p>
            </div>
    
            <div class="u-stackLg">
              <h3 class="boxStickArticle__heading">受けようか迷ってる方へ</h3>
              <p class="p">Reboostを迷っている時点で自分が大きく変化してしまうかもしれない<br class="u-br_pc">恐れだったりがあるんじゃないかなと思います。</p>
              <p class="p">迷うということは奥に変わりたいとか<br class="u-br_pc">変化したいっていうものがあるから迷っていると思うので<br class="u-br_pc">奥にある本当は変わりたいけど変化が怖い、そこに気づいてあげる。<br>その奥にあるものに気づいてあげることが<br class="u-br_pc">まずは第1段階なんじゃないかなと思います。</p>
              <p class="p">そこから自分で行くという決断をしなきゃいけないし<br class="u-br_pc">すごく勇気があることだと思います。</p>
              <p class="p">けど、<span class="u-bold">この低単価でこのプログラム内容って<br class="u-br_pc">私この業界結構関わってきて、いろんなこと学んでいますけど<br class="u-br_pc">他に絶対ないんですね。</span></p>
              <p class="p u-bold">なのでこの内容でこの素晴らしいプログラムを受けない理由は<br class="u-br_pc">私の中ではないんだけど<br class="u-br_pc">決断をするとか変化をしたい自分に気づいてあげるのはご本人しかできないこと。</p>
  ...
  <div class="wrap">
    ...
    <div class="boxGallery">
      <div class="boxGallery__item">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_after_01.jpg?222" srcset="<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_after_01.jpg?222 1x,<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_after_01@2x.jpg?222 2x" alt="2日間終了後の様子" width="367" height="232" loading="lazy" decoding="async">
      </div>
      <div class="boxGallery__item">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_after_02.jpg?222" srcset="<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_after_02.jpg?222 1x,<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_after_02@2x.jpg?222 2x" alt="2日間終了後の様子" width="368" height="232" loading="lazy" decoding="async">
      </div>
      <div class="boxGallery__item">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_after_03.jpg?222" srcset="<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_after_03.jpg?222 1x,<?php echo get_template_directory_uri(); ?>/assets/images/reboost/img_after_03@2x.jpg?222 2x" alt="2日間終了後の様子" width="368" height="232" loading="lazy" decoding="async">
      </div>
    </div>
...
<section id="registration" class="section is-gray">
  ...
  <div class="wrap--narrow">
    <div class="boxCta">
      ...
      <?php endif; ?>
      <a href="https://liff.line.me/1657688022-nXNE1oDa/landing?follow=%40860gpcyg&lp=ldkauu&liff_id=1657688022-nXNE1oDa" target="_blank" rel="noopener" data-btnIcon="&#xf105;" class="boxCta__btn">席が埋まる前に申し込む</a>
...
<section class="section">
  <div class="wrap">
    ...
    <p class="p textMd">「身体と心が変われば人生が変わる」この核心をもとに「フィットネス」と「コーチング」の事業を展開する株式会社GOAL-Bを2019年に創業。<br>「Body（身体）とBe（心）を改革しGOALを達成する」これがGOAL-Bの由来です。</p>
