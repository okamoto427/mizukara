...
<header id="header" class="siteHeader">
  <p class="siteHeader__logo">
    <img src="<?php echo get_template_directory_uri(); ?>/assets/images/shared/logo-renew.svg" alt="ミズカラ" width="118" height="25">
  </p>
  <div class="keyVisual">
...
<section class="sectionCoach">
  ...
  <div class="sectionCoach__inner">
    ...
    <p class="sectionCoach__pos">株式会社ミズカラ <br class="u-br_sp">CEO代表取締役 兼 エグゼクティブコーチ</p>
      ...
      <p class="p">株式会社ミズカラでCEO 代表取締役として仕事を行いながら、代表を務める合同会社LIMITにて、パーソナルジムを10店舗/民泊1棟を経営。</p>
        ...
        <p class="tableAccordion__toggle js-listToggle"><span class="tableAccordion__icon"><span></span><span></span></span></p>
          <div class="tableAccordion__openContent js-openContent">
            <div class="u-stackLg">
              ...
              <p>もう1つは<span class="u-bold">ミズカラさんのYouTubeを見て<br class="u-br_pc">良いチーム、良い会社さんだなと思って参加しようと思いました。</span></p>
            </div>
            <div class="u-stackLg">
    ...
    <div class="boxStickArticle">
      ...
      <div class="boxStickArticle__article">
          ...
          <div class="tableAccordion js-accordion u-stackLg">
            ...
            <div class="u-stackLg">
              <h3 class="boxStickArticle__heading">受講した理由</h3>
              <p class="p">私の周りの数名がミズカラさんのことがすごい好きで<br class="u-br_pc">私のXのタイムラインにもよく出てきてたんです。</p>
              <p class="p">それでミズカラさんのことを知っていくようになって<br class="u-br_pc">LINEに登録したらReboostのオンライン体験会の案内が届きました。</p>
              <p class="p">Reboost講師の村岡さんがお話しされる内容で興味を持って<br class="u-br_pc">村岡さんが面白いのなんのって、この人やばいって思ったんです。</p>
              <p class="p">ミズカラさんに興味があったし行ってみたいな、と。</p>
      ...
      <div class="boxStickArticle__article">
          ...
          <p class="u-stackLg">日々の中で当たり前のことにすごく感謝をしたり<br class="u-br_pc"><span class="u-bold">表面的なものではなくて内側から湧いてきて<br class="u-br_pc">本当に1つ1つの幸せを噛みしめるような生き方になりました。</span></p>
            ...
            <div class="u-stackLg">
              ...
              <p class="p">自分自身もコーチングに近いライフコーチングを、<br class="u-br_pc">ミズカラが提供しているものとはちょっと違うと思うのですが、<br class="u-br_pc">その組み立てをしていく中でのヒントもすごくありました。</p>
...
<section class="section">
  <div class="wrap">
    ...
    <p class="p textMd">「身体と心が変われば人生が変わる」この核心をもとに「フィットネス」と「コーチング」の事業を展開する株式会社ミズカラを2019年に創業。<br>「Body（身体）とBe（心）を改革しGOALを達成する」これがミズカラの由来です。</p>
