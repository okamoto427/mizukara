...
<head>
    ...
    <link rel="stylesheet"
        href="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets-career_gsn_co/css/styles09.css" />
            ...
            <div class="reason__wrap">
                ...
                <div class="reason__item reason__item--reverse wow animated fadeInRight" data-wow-delay=".8s">
                    <div class="reason__main">
                        ...
                        <h3 class="reason__title-ja">理想から考える目標設定が<br />行動力を加速させる</h3>
