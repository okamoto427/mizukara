	...
	<div class="l-header__menus">
		...
		<nav class="nav-global">
			...
			<div class="nav-row">
				...
				<ul class="nav-link">
					<li><a href="#" target="_blank">ミズカラマガジン</a></li>
...
<div class="home-cover" data-appear-on="load">
	<div class="home-cover__texts">
		...
		<div class="home-cover__text03" data-appear-animation="blackTapeText">ミズカラは<br class="sp">「全ての人に可能性がある」を体現し続けます。</div>
	</div>
	...
	<div class="m-about__inner">
		...
		<div class="m-about__items">
			<div class="m-about__title">
				<h2 class="m-title01"><span class="english" data-appear-animation="blackTapeTextRotated">ABOUT</span><span class="japanese" data-appear-animation="blackTapeTextRotated">ミズカラについて</span></h2>
			</div>
...
<section class="home-business">
	<div class="home-business__inner">			
		<h2 class="m-title02 -center mb30"><span class="english">OUR BUSINESS</span><span class="japanese">ミズカラが提供するサービス・事業</span></h2>
...
<section class="home-member">
	<div class="home-member__inner">
		...
		<h2 class="m-title02 -center"><span class="english">MEMBER</span><span class="japanese">ミズカラのメンバー</span></h2>
...
<section class="home-media">
	<div class="home-media__inner" data-appear-on="scroll">	
		<div class="tape-gray home-media__bg01" data-appear-animation="grayTape"></div>
			...
			<h2 class="m-title02"><span class="english">MEDIA</span><span class="japanese">ミズカラメディア</span></h2>
			...
			<div class="home-social__item">
				<a href="https://youtube.com/@GOALB" target="_blank">
					...
					<div class="home-social__texts">
						...
						<div class="home-social__text02">ミズカラの最新情報や、<br>お客様のインタビューを配信中</div>
					</div>
				</a>
			</div>		
			<div class="home-social__item">
	...
	<div class="m-imagetext__inner">
		...
		<div class="m-imagetext__items">
			...
			<div class="m-imagetext__texts">
				<div class="m-imagetext__text01">ミズカラで共に<br>可能性を体現しよう</div>
				<div class="m-imagetext__text02">あなたもミズカラの仲間として働き、<br>お客さまの自分史上最高を<br class="sp">引き出していきませんか。</div>
				<div class="m-buttonMore">
