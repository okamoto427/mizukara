        ...
        <div class="payment-main">
            <div class="payment-wrapper">
                <div class="payment-tab">
                    <button id="tab-standard" class="payment-tab__item" onclick="toggleVisibility('standard')">スタンダード</button>
                    <button id="tab-breakthrough" class="payment-tab__item is-active" onclick="toggleVisibility('breakthrough')">ブレイクスルー</button>
                    <button id="tab-premium" class="payment-tab__item" onclick="toggleVisibility('premium')">プレミアム</button>
                </div>
                ...
                <div id="plan-standard" class="payment-card">
                    <div class="payment-card__plan-wrap">
                        ...
                        <p class="payment-card__description">セッション回数13回</p>
                        <p class="payment-card__description">(グループセッション4回 + 本セッション9回)</p>
                    </div>
                    ...
                    <button class="payment-card__button">
                        <a href="javascript:void(0);" onclick="f_submit(custCode,opportunityId,'careerspeed-standard','スタンダードプラン',580800)">決済画面に進む</a>
                    </button>
                </div>

                <!-- ブレイクスループラン -->
                <div id="plan-breakthrough" class="payment-card is-active">
                    <div class="payment-card__plan-wrap">
                        <h2 class="payment-card__title">ブレイクスループラン</h2>
                        <div class="payment-card__title-line"></div>
                        <p class="payment-card__description">セッション回数13回</p>
                        <p class="payment-card__description">(グループセッション4回 + 本セッション9回)</p>
                        <p class="payment-card__description">セルフコーチング用動画教材</p>
                    </div>

                    <dic class="payment-card__price-wrap">
                        <h3 class="payment-card__price">800,800円<span>（税込み）</span></h3>
                        <hr class="payment-card__price-divider" />
                        <p class="payment-card__price-detail">プラン料金 698,000円 + <br class="payment-only-sp">入会金 33,000円</p>
                    </dic>

                    <button class="payment-card__button">
                        <a href="javascript:void(0);" onclick="f_submit(custCode,opportunityId,'careerspeed-breakthrough','ブレイクスループラン',800800)">決済画面に進む</a>
                    </button>
                </div>

                <!-- プレミアムブレイクスループラン -->
                <div id="plan-premium" class="payment-card">
                    <div class="payment-card__plan-wrap">
                    ...
                    <dic class="payment-card__price-wrap">
                        <h3 class="payment-card__price">1,133,000円<span>（税込み）</span></h3>
                        <hr class="payment-card__price-divider" />
                        <p class="payment-card__price-detail">プラン料金 1,000,000円 + <br class="payment-only-sp">入会金 33,000円</p>
                    </dic>

                    <button class="payment-card__button">
                        <a href="javascript:void(0);" onclick="f_submit(custCode,opportunityId,'careerspeed-premiumbreakthrough','プレミアムブレイクスループラン',1133000)">決済画面に進む</a>
                    </button>
                </div>
            </div>
        </div>
