<?php get_header(null,[
  'description' => 'ミズカラの資料ダウンロードページです。サービス詳細のほか、お役立ち資料をご用意しております。'
]); ?>
...
<p class="mb100">各サービスの内容や料金のほか、ミズカラが培ってきたコーチングサービスをわかりやすくまとめた各種資料をご用意しました。<br>成功事例やお客様の声、コーチングの詳細なプログラムなどをご覧いただけます。<br>ダウンロードの上、ぜひご活用ください。</p>
